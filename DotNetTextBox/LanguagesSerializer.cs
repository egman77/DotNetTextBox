...
namespace DotNetTextBox 
{
    public class XmlSerializationWriterLanguages : System.Xml.Serialization.XmlSerializationWriter {
        ...
        public void Write6_Languages(object o) {
            ...
            TopLevelElement();
            Write5_Languages(@"Languages", @"", ((global::DotNetTextBox.Languages)o), true, false);
        }

        void Write5_Languages(string n, string ns, global::DotNetTextBox.Languages o, bool isNullable, bool needType) {
            if ((object)o == null) {
            ...
            if (!needType) {
                ...
                if (t == typeof(global::DotNetTextBox.Languages)) {
                }
                else {
            ...
            if (needType) WriteXsiType(@"Languages", @"");
            {
                ...
                if (a != null){
                    ...
                    for (int ia = 0; ia < ((System.Collections.ICollection)a).Count; ia++) {
                        Write4_Language(@"Language", @"", ((global::DotNetTextBox.Language)a[ia]), true, false);
                    }
                    WriteEndElement();
                }
            }
        ...
        void Write4_Language(string n, string ns, global::DotNetTextBox.Language o, bool isNullable, bool needType) {
            if ((object)o == null) {
                if (isNullable) WriteNullTagLiteral(n, ns);
                return;
            }
            if (!needType) {
                System.Type t = o.GetType();
                if (t == typeof(global::DotNetTextBox.Language)) {
                }
                else {
                    throw CreateUnknownTypeException(o);
                }
            ...
            WriteAttribute(@"StyleType", @"", Write3_StyleType(((global::DotNetTextBox.StyleType)o.@StyleType)));
            ...
            WriteAttribute(@"DivInlineStyleFont", @"", ((global::System.String)o.@DivInlineStyleFont));
            {
                ...
                if (a != null){
                    ...
                    for (int ia = 0; ia < ((System.Collections.ICollection)a).Count; ia++) {
                        Write2_CodeElement(@"CodeElement", @"", ((global::DotNetTextBox.CodeElement)a[ia]), true, false);
                    }
                    WriteEndElement();
                }
            }
        ...
        void Write2_CodeElement(string n, string ns, global::DotNetTextBox.CodeElement o, bool isNullable, bool needType) {
            if ((object)o == null) {
                if (isNullable) WriteNullTagLiteral(n, ns);
                return;
            }
            if (!needType) {
                System.Type t = o.GetType();
                if (t == typeof(global::DotNetTextBox.CodeElement)) {
                }
                else {
                    throw CreateUnknownTypeException(o);
                }
        ...
        string Write3_StyleType(global::DotNetTextBox.StyleType v) {
            string s = null;
            switch (v) {
                case global::DotNetTextBox.StyleType.@InlineStyles: s = @"InlineStyles"; break;
                case global::DotNetTextBox.StyleType.@InlineTags: s = @"InlineTags"; break;
                case global::DotNetTextBox.StyleType.@GlobalStyles: s = @"GlobalStyles"; break;
    ...
    public class XmlSerializationReaderLanguages : System.Xml.Serialization.XmlSerializationReader {
        ...
        global::DotNetTextBox.Languages Read5_Languages(bool isNullable, bool checkType) {
            ...
            global::DotNetTextBox.Languages o;
            o = new global::DotNetTextBox.Languages();
        ...
        global::DotNetTextBox.Language Read4_Language(bool isNullable, bool checkType) {
            System.Xml.XmlQualifiedName xsiType = checkType ? GetXsiType() : null;
            bool isNull = false;
            if (isNullable) isNull = ReadNull();
            if (checkType) {
            ...
            if (isNull) return null;
            global::DotNetTextBox.Language o;
            o = new global::DotNetTextBox.Language();
        ...
        global::DotNetTextBox.CodeElement Read2_CodeElement(bool isNullable, bool checkType) {
            System.Xml.XmlQualifiedName xsiType = checkType ? GetXsiType() : null;
            bool isNull = false;
            if (isNullable) isNull = ReadNull();
            if (checkType) {
            ...
            if (isNull) return null;
            global::DotNetTextBox.CodeElement o;
            o = new global::DotNetTextBox.CodeElement();
        ...
        global::DotNetTextBox.StyleType Read3_StyleType(string s) {
            switch (s) {
                case @"InlineStyles": return global::DotNetTextBox.StyleType.@InlineStyles;
                case @"InlineTags": return global::DotNetTextBox.StyleType.@InlineTags;
                case @"GlobalStyles": return global::DotNetTextBox.StyleType.@GlobalStyles;
                default: throw CreateUnknownConstantException(s, typeof(global::DotNetTextBox.StyleType));
            }
        }
    ...
    public class XmlSerializerContract : global::System.Xml.Serialization.XmlSerializerImplementation {
        ...
        public override System.Boolean CanSerialize(System.Type type) {
            if (type == typeof(global::DotNetTextBox.Languages)) return true;
            return false;
        }
        public override System.Xml.Serialization.XmlSerializer GetSerializer(System.Type type) {
            if (type == typeof(global::DotNetTextBox.Languages)) return new LanguagesSerializer();
            return null;
        }
    }
}
