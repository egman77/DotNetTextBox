...
<span id='MyFile'><%=ResourceManager.GetString("adduploadfile")%>：<span num='1'><asp:FileUpload ID="FileUpload1" runat="server" Font-Size="10pt" Height="21px" onchange="addFile()"
    ...
    <asp:Label ID="maxupload" runat="server" ForeColor="red"></asp:Label>]<br />
...
<asp:Panel id="filelistdiv" runat=server><div id="fileshow" style="border-right: 1.5pt inset; border-top: 1.5pt inset; vertical-align: middle;
