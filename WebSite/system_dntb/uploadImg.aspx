...
<span id='MyFile'><%=ResourceManager.GetString("uploadimages")%>：<span num='1'><asp:FileUpload ID="FileUpload1" runat="server" Width="300px" Height="21px" TabIndex="2" Font-Size="10pt" onchange="addFile()" /></span></span><asp:TextBox ID="remoteurl" runat="server" Visible="False" Text="http://" Width="250px"></asp:TextBox>
<asp:Button ID="addurl" runat="server" Visible="False" Width="49px" OnClick="addurl_Click" />
    [<asp:Label ID="maxuploadfile" runat="server" />
    <asp:Label ID="maxupload" runat="server" ForeColor="red" />]<br /><asp:Panel ID="batchPanel" runat="server" Width="100%">
    <table>
        <tr>
            <td>
...
height: 240px; background-color: white" runat=server>
...
</tr></table></asp:Panel></fieldset></asp:Panel>
<asp:Panel ID="imageAttribute" runat=server>
<fieldset><legend><span style="color: dimgray"><span style="color: gray"><%=ResourceManager.GetString("imagepreview")%></span>&nbsp;<asp:ImageButton ID="imageturn" CommandName="hide" ImageAlign=AbsBottom ImageUrl="img/hide.gif" runat="server" OnClick="imageturn_Click" /></span></legend>
<asp:Panel ID="imagesdiv" runat="server"><table height="100%" width="100%">
<tr>
<td rowspan="3">
